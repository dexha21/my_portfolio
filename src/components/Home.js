  ...
  return (
    <section className="home">
      <div className=".home-container">
        ...
        <p >
          With a strong passion for crafting high-quality, scalable web and mobile applications, I bring a wealth of experience in both front-end and back-end development. My expertise spans across various technologies including React, PHP, jQuery, MySQL, and more. I am committed to delivering solutions that not only meet client expectations but also push the boundaries of innovation in web development.
        </p>
